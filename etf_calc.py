...
target_ratio = float(input("Enter desired developed/emerging market ratio (in %): ")) / 100.
x, y, z = calculate_etf_ratios(target_ratio, 0.9, 0.65, 0.11, 1.5)
if x < 0 or y < 0 or z < 0:
    print("Error: One or more negative weights. Make sure your desired DM:EM ratio is achievable.")
    exit(1)
